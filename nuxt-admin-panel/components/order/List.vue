  ...
  <div class="table-responsive">
    <table class="table align-middle">
      ...
      <tr v-for="order in props.orders" :key="order.id">
        ...
        <td>
          <div class="d-flex">
            <button class="btn btn-sm btn-dark" data-bs-toggle="modal" :data-bs-target="`#modal-${order.id}`">
              نمایش
            </button>
            <div>
                ...
                <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h6 class="modal-title">محصولات سفارش شماره {{ order.id }}</h6>
                    ...
                    <div class="modal-body">
                      <table class="table align-middle">
                        ...
                        <tr v-for="orderItem in order.order_items" :key="orderItem.id">
                          <th>
                            <img src="/images/preloader.png" v-img="orderItem.product_primary_image" width="80">
                          </th>
