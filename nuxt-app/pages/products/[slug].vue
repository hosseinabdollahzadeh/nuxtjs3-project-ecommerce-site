              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img class="d-block w-100" src="/images/preloader.png" width="464" height="309" v-img="product.data.primary_image" alt="" />
                  </div>

                  <div  v-for="(image, index) in product.data.images" :key="index" class="carousel-item">
                    <img class="d-block w-100" src="/images/preloader.png" width="464" height="309" v-img="image.image" alt="" />
                  </div>
                </div>
